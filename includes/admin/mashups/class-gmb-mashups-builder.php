	...
	public function mashup_builder_fields() {
		...
		$group_field_id = $mashup_metabox->add_field( array(
			...
			'options'     => array(
				...
				'sortable'      => false, // beta
				'label_cb' =>  render_maker_field_tooltip( 'render_marker_mashup_group_tooltip' ),
		...
		$mashup_metabox->add_group_field( $group_field_id, array(
			...
			'label_cb' =>  render_maker_field_tooltip( 'render_marker_post_type_tooltip' ),
		) );
		$mashup_metabox->add_group_field( $group_field_id, array(
			...
			'label_cb' =>  render_maker_field_tooltip( 'render_marker_taxonomy_tooltip' ),
		) );
		$mashup_metabox->add_group_field( $group_field_id, array(
			...
			'type'        => 'select_terms',
			'label_cb' =>  render_maker_field_tooltip( 'render_marker_terms_tooltip' ),
		) );
		$mashup_metabox->add_group_field( $group_field_id, array(
			...
			'label_cb' =>  render_maker_field_tooltip( 'render_marker_latitude_tooltip' ),
		) );
		$mashup_metabox->add_group_field( $group_field_id, array(
			...
			'type'        => 'select_custom_meta',
			'label_cb' =>  render_maker_field_tooltip( 'render_marker_longitude_tooltip' ),
		) );
		$mashup_metabox->add_group_field( $group_field_id, array(
			...
			'type'        => 'radio_inline',
			'label_cb' =>  render_maker_field_tooltip( 'render_marker_featured_img_tooltip' ),
		) );
		$mashup_metabox->add_group_field( $group_field_id, array(
