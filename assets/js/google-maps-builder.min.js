...
var a=new google.maps.InfoWindow({maxWidth:315}),t=$(e).data("map-id"),o=gmb_data[t],n=o.map_params.latitude?o.map_params.latitude:"32.713240",i=o.map_params.longitude?o.map_params.longitude:"-117.159443",r={center:new google.maps.LatLng(n,i),zoom:parseInt(o.map_params.zoom),styles:[{stylers:[{visibility:"simplified"}]},{elementType:"labels",stylers:[{visibility:"off"}]}]};map=new google.maps.Map(e[0],r),places_service=new google.maps.places.PlacesService(map),set_map_options(map,o),set_map_theme(map,o),set_map_markers(map,o,a),set_map_directions(map,o),set_map_layers(map,o),
//Display places?
...
var r=$(this).find(".cmb-repeat-row"),s=o.point[0].latitude,l=o.point[0].longitude,p=o.point[o.point.length-1].latitude,m=o.point[o.point.length-1].longitude,_=o.travel_mode.length>0?o.travel_mode:"DRIVING",c=[];r.not(":first").not(":last").each(function(e,a){var t=$(this).find(".gmb-directions-latitude").val(),o=$(this).find(".gmb-directions-longitude").val();c.push({location:t+","+o,stopover:!0})});var d={origin:s+","+l,destination:p+","+m,waypoints:c,optimizeWaypoints:!0,travelMode:google.maps.TravelMode[_]};n.route(d,function(e,a){a==google.maps.DirectionsStatus.OK&&
...
i.setDirections(e)})}})}/**
	 ...
	 * @param map_data
	 */
function set_map_layers(e,a){}var map,places_service,place,directionsDisplay=[],search_markers=[];/*
