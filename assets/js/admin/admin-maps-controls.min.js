...
google.maps.event.addDomListener(o,"keydown",function(e){13==e.keyCode&&e.preventDefault()})}/**
	 ...
	 *
	 */
function n(){var o=e(".map-autocomplete-wrap"),a=e("#map-location-autocomplete").get(0),t=new google.maps.places.Autocomplete(a);t.bindTo("bounds",map),google.maps.event.addListener(t,"place_changed",function(){var a=t.getPlace();
// If the place has a geometry, then present it on a map.
//Close modal
return a.geometry?(a.geometry.viewport?map.fitBounds(a.geometry.viewport):(map.setCenter(a.geometry.location),map.setZoom(17)),e(o).find(".mfp-close").trigger("click"),void r(o)):void window.alert("Autocomplete's returned place contains no geometry")}),
//Tame the enter key to not save the widget while using the autocomplete input
...
//Places Search
var t=e(".cmb2-id-gmb-places-search input");t.on("change",function(){a(e(this))}),a(t),n(),
...
r(a)}),
//Close button
e(".gmb-modal-close").on("click",function(){r(a)})):e.magnificPopup.open({items:{src:e(a),type:"inline"},midClick:!0})}),
