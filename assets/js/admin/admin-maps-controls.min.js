...
// If the place has a geometry, then present it on a map.
//Close modal
return t.geometry?(t.geometry.viewport?map.fitBounds(t.geometry.viewport):(map.setCenter(t.geometry.location),map.setZoom(17)),e(o).find(".mfp-close").trigger("click"),void r(o)):void window.alert("Autocomplete's returned place contains no geometry")}),
//Tame the enter key to not save the widget while using the autocomplete input
...
e(o).addClass("mfp-hide").appendTo(".modal-placeholder").unwrap()}/**
	 ...
	 */
function i(){e("#modal_title").on("blur",function(){e("input#title").val(e(this).val())})}/**
...
r(t)}),
//Close button
e(".gmb-modal-close").on("click",function(){r(t)})):e.magnificPopup.open({items:{src:e(t),type:"inline"},midClick:!0})}),
