...
"undefined"==typeof placeSearchAutocomplete&&o.prop("checked")===!0?(a(),//hasn't been setup yet, so set it up
...
// Autocomplete.
function e(e,o){var t=document.getElementById(e);google.maps.event.addDomListener(t,"click",function(){placeSearchAutocomplete.setTypes(o)})}{var o=/** @type {HTMLInputElement} */document.getElementById("pac-input");document.getElementById("type-selector")}map.controls[google.maps.ControlPosition.TOP_CENTER].push(document.getElementById("places-search")),placeSearchAutocomplete=new google.maps.places.Autocomplete(o),placeSearchAutocomplete.bindTo("bounds",map);var t=new google.maps.InfoWindow,a=new google.maps.Marker({map:map,anchorPoint:new google.maps.Point(0,-29)});google.maps.event.addListener(placeSearchAutocomplete,"place_changed",function(){t.close(),a.setVisible(!1);var e=placeSearchAutocomplete.getPlace();if(!e.geometry)return void window.alert("Autocomplete's returned place contains no geometry");
// If the place has a geometry, then present it on a map.
e.geometry.viewport?map.fitBounds(e.geometry.viewport):(map.setCenter(e.geometry.location),map.setZoom(17)),a.setIcon(/** @type {google.maps.Icon} */{url:e.icon,size:new google.maps.Size(71,71),origin:new google.maps.Point(0,0),anchor:new google.maps.Point(17,34),scaledSize:new google.maps.Size(35,35)}),a.setPosition(e.geometry.location),a.setVisible(!0);var o="";e.address_components&&(o=[e.address_components[0]&&e.address_components[0].short_name||"",e.address_components[1]&&e.address_components[1].short_name||"",e.address_components[2]&&e.address_components[2].short_name||""].join(" ")),t.setContent("<div><strong>"+e.name+"</strong><br>"+o),t.open(map,a)}),e("changetype-all",[]),e("changetype-address",["address"]),e("changetype-establishment",["establishment"]),e("changetype-geocode",["geocode"]),
...
google.maps.event.addDomListener(o,"keydown",function(e){13==e.keyCode&&e.preventDefault()})}/**
	 ...
	 *
	 */
function n(){var o=e(".map-autocomplete-wrap"),t=e("#map-location-autocomplete").get(0),a=new google.maps.places.Autocomplete(t);a.bindTo("bounds",map),google.maps.event.addListener(a,"place_changed",function(){var t=a.getPlace();
// If the place has a geometry, then present it on a map.
//Close modal
return t.geometry?(t.geometry.viewport?map.fitBounds(t.geometry.viewport):(map.setCenter(t.geometry.location),map.setZoom(17)),e(o).find(".mfp-close").trigger("click"),void i(o)):void window.alert("Autocomplete's returned place contains no geometry")}),
//Tame the enter key to not save the widget while using the autocomplete input
...
e(o).addClass("mfp-hide").appendTo(".modal-placeholder").unwrap()}/**
	 ...
	 *
	 */
function r(){e("button.edit-title").on("click",function(){
// Move back out of container
...
e(".map-title-wrap").on("click",function(o){console.log(e(o.target)),console.log(e(o.target).hasClass("inner-modal-wrap")),
//only on overlay
...
//Places Search
var a=e(".cmb2-id-gmb-places-search input");a.on("change",function(){t(e(this))}),t(a),
//Autocomplete
n(),
//Edit Title
r(),
//Initialize Magnific/Modal Functionality Too
e("body").on("click",".gmb-magnific-inline",function(o){o.preventDefault();var t="."+e(this).data("target");//target element class name
//Modal in modal?
...
i(t)}),
//Close button
e(".gmb-modal-close").on("click",function(){i(t)})):e.magnificPopup.open({items:{src:e(t),type:"inline"},midClick:!0})}),
