...
//default icon
marker_icon_data=gmb_data.default_marker,$("#gmb_markers_group_"+index+"_marker").val(""),marker_label_data="";else if("mapicons"==marker_icon){var marker_icon_data=$(this).data("marker-image");marker_label_data="",//no label here (img marker)
$("#gmb_markers_group_"+index+"_marker_img").val(marker_icon_data),//set marker image field
$("#gmb_markers_group_"+index+"_marker","#gmb_markers_group_"+index+"_label").val("")}else("MAP_PIN"==marker_icon||"SQUARE_PIN"==marker_icon)&&(
//maps-icon
...
//Marker Item Click
$(".marker-item").on("click",function(){var a=$(this).data("marker");$(".marker-item").removeClass("marker-item-selected"),$(this).addClass("marker-item-selected"),o.attr("data-marker",a),//Set marker data attribute on save bt
//default marker
"default"==a?(
//Slide up all panels
e.slideUp(),t.slideDown()):"mapicons"==a?(e.hide(),$(".map-icons-row").slideDown()):("MAP_PIN"==a||"SQUARE_PIN"==a)&&(e.hide(),$(".map-svg-icons").slideDown())}),
