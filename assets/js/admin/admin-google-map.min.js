...
if(map=new google.maps.Map(e[0],o),window.map=map,places_service=new google.maps.places.PlacesService(map),console.log(gmb_data),
...
"default"==marker_icon?(
//default icon
marker_icon_data=gmb_data.default_marker,$("#gmb_markers_group_"+index+"_marker").val(""),marker_label_data=""):"mapicons"==marker_icon||"upload"==marker_icon?(marker_icon_data=$(this).data("marker-image"),marker_label_data="",//no label here (img marker)
...
$("#gmb_markers_group_repeat .cmb-repeatable-grouping").each(function(index){var marker_icon=gmb_data.default_marker,marker_label="",custom_marker_icon=$("#gmb_markers_group_"+index+"_marker").val(),custom_marker_img=$("#gmb_markers_group_"+index+"_marker_img").val();if(custom_marker_img)marker_icon=custom_marker_img;else if(custom_marker_icon.length>0&&custom_marker_icon.length>0){var custom_label=$("#gmb_markers_group_"+index+"_label").val();marker_icon=eval("("+custom_marker_icon+")"),marker_label=custom_label}
//Marker for map
