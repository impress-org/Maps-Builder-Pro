...
info_bubble.close(),a.setVisible(!1)})}/**
	 ...
	 */
function get_marker_index(){var e=$("#gmb_markers_group_repeat"),a=e.find(" div.cmb-repeatable-grouping"),t=e.find(".cmb-add-group-row.button"),o=parseInt(a.last().attr("data-iterator")),i=$('div[data-iterator="0"]',a).find("input,textarea").val();
//Ensure appropriate index is used for marker
//recount rows
return console.log(i),i&&0===o?(t.trigger("click"),o=1):0!==o&&(t.trigger("click"),o=parseInt(a.last().attr("data-iterator"))),console.log(o),o}/**
