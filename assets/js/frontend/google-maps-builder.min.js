...
var a=new google.maps.InfoWindow({maxWidth:315}),o=$(e).data("map-id"),t=gmb_data[o],n=t.map_params.latitude?t.map_params.latitude:"32.713240",i=t.map_params.longitude?t.map_params.longitude:"-117.159443",s={center:new google.maps.LatLng(n,i),zoom:parseInt(t.map_params.zoom),styles:[{stylers:[{visibility:"simplified"}]},{elementType:"labels",stylers:[{visibility:"off"}]}]};map=new google.maps.Map(e[0],s),places_service=new google.maps.places.PlacesService(map),set_map_options(map,t),set_map_theme(map,t),set_map_markers(map,t,a),set_map_directions(map,t),set_map_layers(map,t),set_map_places_search(map,t),
//Display places?
...
var s={key:gmb_data.api_key,location:new google.maps.LatLng(t.lat(),t.lng()),types:n,radius:a.places_api.search_radius};places_service.nearbySearch(s,function(a,t,n){var i,s=0;
//setup new markers
if(t==google.maps.places.PlacesServiceStatus.OK){
//place new markers
for(s=0;i=a[s];s++)create_search_result_marker(e,a[s],o);
...
var s=$(this).find(".cmb-repeat-row"),r=t.point[0].latitude,l=t.point[0].longitude,p=t.point[t.point.length-1].latitude,m=t.point[t.point.length-1].longitude,c=t.travel_mode.length>0?t.travel_mode:"DRIVING",d=[];s.not(":first").not(":last").each(function(e,a){var o=$(this).find(".gmb-directions-latitude").val(),t=$(this).find(".gmb-directions-longitude").val();d.push({location:o+","+t,stopover:!0})});var _={origin:r+","+l,destination:p+","+m,waypoints:d,optimizeWaypoints:!0,travelMode:google.maps.TravelMode[c]};n.route(_,function(e,a){a==google.maps.DirectionsStatus.OK&&
