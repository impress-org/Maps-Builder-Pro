...
var r=$(this).find(".cmb-repeat-row"),s=t.point[0].latitude,l=t.point[0].longitude,p=t.point[t.point.length-1].latitude,m=t.point[t.point.length-1].longitude,c=t.travel_mode.length>0?t.travel_mode:"DRIVING",d=[];r.not(":first").not(":last").each(function(e,a){var o=$(this).find(".gmb-directions-latitude").val(),t=$(this).find(".gmb-directions-longitude").val();d.push({location:o+","+t,stopover:!0})});var _={origin:s+","+l,destination:p+","+m,waypoints:d,optimizeWaypoints:!0,travelMode:google.maps.TravelMode[c]};n.route(_,function(e,a){a==google.maps.DirectionsStatus.OK&&
